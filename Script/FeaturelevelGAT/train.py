...
wandb.init(project="CGCom", entity="honglin-wang",notes='All genes feature level attention GNN model',name='Attention GNN model modified',)

wbconfig = wandb.config
wbconfig.learning_rate = learning_rate
wbconfig.epochs = num_epochs
